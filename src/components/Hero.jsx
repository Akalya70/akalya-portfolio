...
export default function Hero() {
  return (
    <section id="home" className="relative pt-32 pb-24 md:pt-40 md:pb-32 overflow-hidden">
      {/* Ambient background — single restrained glow */}
      <div className="absolute top-16 -left-24 w-[28rem] h-[28rem] bg-primary/10 rounded-full blur-3xl" aria-hidden="true" />
      ...
      <div className="section-container grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="relative w-72 h-80 md:w-80 md:h-96">
            {/* Single soft glow behind the card */}
            <div className="absolute -top-6 -left-8 w-48 h-48 bg-primary/15 rounded-full blur-3xl" aria-hidden="true" />

            {/* One offset panel for depth */}
            ...
            {/* Signature floating status badge */}
            <motion.div
            ...
            >
              ...
              <div className="leading-tight">
                <p className="text-xs font-semibold text-heading">Final-year CSE</p>
                <p className="text-[11px] text-body">Open to opportunities</p>
              </div>
            </motion.div>
          </div>
        </motion.div>
